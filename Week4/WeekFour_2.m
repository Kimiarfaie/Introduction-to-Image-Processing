...
%%
%Spekle
% img1 = imnoise(img,'speckle',rand(1));
% imwrite(img1,'Distorted image with Speckle.jpg');
img1 = imread("distorted image with speckle.jpg"); %just to have a saved image of salt and pepper
img1 = im2double(img1);
p = zeropadding(img1);
%%
%Average filter
...
imwrite(B,'Average Filter.jpg');
%Difference between two images
D1 = imabsdiff(img,B);
imwrite(D1,'Difference-Average.jpg');
